// Based on Google VR v1.0.0 GazeInputModule.cs
...
public class OurGazeInputModule : BaseInputModule
{
    ...
    public static IGazeClicker gazeClicker;
    ...
    handlePendingClickRequired &= !GvrController.ClickButton;
        ...
        else if (Time.unscaledTime - pointerData.clickTime < clickTime)
        {
          ...
          (GvrViewer.Instance.Triggered || 
           ...
           (gazeClicker != null && gazeClicker.ShouldTrigger()) ))
        {
            // New trigger action.
            HandleTrigger();
        }
