...
% ---
\TODO{"colocar um parágrafo introduzindo essa seção."}
...
\TODO{"faltou a fonte sobre leap nos primeiro parágrafos da seção."}
...
o possível. Para alcançar tal objetivo, o \textit{headset} é feito de papelão, 
