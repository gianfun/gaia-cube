...
Quanto a dispositivos de realidade virtual, duas alternativas ao \textit{Google Cardboard} foram trazidas em questão: os \textit{headsets} \textit{Oculus Rift} e o \textit{HTC} Vive. 
