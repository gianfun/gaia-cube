...
namespace Leap.Unity
{
  ...
  public class Hand
  {
     ...
     * @since 1.0
     */
    public List<Finger> Fingers { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector PalmPosition { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector PalmVelocity { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector PalmNormal { get; internal set; }
    ...
    */
     ...
     * @since 2.0
     */
    public float GrabStrength { get; internal set; }
     ...
     * @since 3.0
     */
    public float GrabAngle { get; internal set; }
     ...
     * @since 2.0
     */
    public float PinchStrength { get; internal set; }
     ...
     * @since 3.0
     */
    public float PinchDistance { get; internal set; }
     ...
     * @since 2.0
     */
    public float PalmWidth { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector StabilizedPalmPosition { get; internal set; }
     ...
     * @since 2.0.3
     */
    public Vector WristPosition { get; internal set; }
     ...
     * @since 2.0.3
     */
    public Arm Arm { get; internal set; }
  }
}
