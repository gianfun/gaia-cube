...
namespace Leap.Unity
{
  ...
  public class Finger
  {
    internal Bone[] _bones = new Bone[4];
    long _frameId = -1;
     ...
     * @since 2.0
     */
    public Finger.FingerType Type { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector TipPosition { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector TipVelocity { get; internal set; }
     ...
     * @since 1.0
     */
    public Vector StabilizedTipPosition { get; internal set; }
