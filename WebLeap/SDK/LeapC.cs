...
namespace Leap.Unity
{
  ...
  public struct LEAP_VECTOR
  {
    ...
    public Leap.Unity.Vector ToLeapVector()
    {
      return new Leap.Unity.Vector(x, y, z);
    }

    public LEAP_VECTOR(Leap.Unity.Vector leap)
    {
      x = leap.x;
      y = leap.y;
      z = leap.z;
  ...
  public struct LEAP_QUATERNION
  {
    ...
    public LEAP_QUATERNION(Leap.Unity.LeapQuaternion q)
    {
      x = q.x;
      y = q.y;
      z = q.z;
      w = q.w;
        ...
        public Leap.Unity.LeapQuaternion ToLeapQuaternion()
        {
            return new Leap.Unity.LeapQuaternion(this.x, this.y, this.z, this.w);
        }
    }
